...
export const LogoHeader: React.FC<LogoHeaderProps> = ({ logoUrl }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-8 pb-6 px-4 text-center relative overflow-hidden select-none">
      ...
      >
        ...
        <motion.div 
          ...
          className="absolute -inset-4 rounded-full bg-gradient-to-r from-cyan-500/30 via-blue-500/40 to-cyan-400/30 blur-xl pointer-events-none"
        />

        {activeLogo ? (
          /* Custom Image Logo View */
          <div className="relative w-44 h-44 sm:w-52 sm:h-52 rounded-full overflow-hidden border-2 border-cyan-400/80 shadow-[0_0_35px_rgba(0,210,255,0.6)] bg-slate-950 p-1 flex items-center justify-center">
            <img 
              src={activeLogo} 
          ...
          <div className="relative w-44 h-44 sm:w-52 sm:h-52 drop-shadow-[0_0_25px_rgba(0,210,255,0.6)]">
      ...
      <div className="mt-4 max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-950/80 border border-sky-500/30 text-sky-300 text-xs sm:text-sm font-semibold tracking-wide mb-3 backdrop-blur-md">
        ...
        <p className="text-sky-200/80 text-sm sm:text-base mt-2 font-medium">
